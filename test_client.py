...
# ethernet_frame = Ether(src='f2:3e:82:54:05:c5', dst='b6:9d:50:bf:43:b2', type=)
...
# send 100 dummpy ethernet frames, with payload 'hello world'
for i in range(100):
    ethernet_frame = Ether(src='f2:3e:82:54:05:c5', dst='b6:9d:50:bf:43:b2')
    packet = ethernet_frame / 'hello world'
    sendp(packet, iface='veth2-1')
